...
class BuyMembershipWidget extends StatefulWidget {
  const BuyMembershipWidget({Key? key}) : super(key: key);

  @override
  _BuyMembershipWidgetState createState() => _BuyMembershipWidgetState();
}

class _BuyMembershipWidgetState extends State<BuyMembershipWidget> {
