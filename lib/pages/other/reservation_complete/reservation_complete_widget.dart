...
import 'reservation_complete_model.dart';
export 'reservation_complete_model.dart';
...
class _ReservationCompleteWidgetState extends State<ReservationCompleteWidget> {
  late ReservationCompleteModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReservationCompleteModel());
