      ...
      child: Scaffold(
        ...
        body: SafeArea(
          ...
          child: FutureBuilder<int>(
            future: queryReservationsRecordCount(
              ...
              return SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    if (valueOrDefault(currentUserDocument?.b2bType, '') ==
                        'team')
                      Align(
                          ...
                          child: AuthUserStreamWidget(
                            builder: (context) =>
                              ...
                              builder: (context, snapshot) {
                                ...
                                final cardCompaniesRecord = snapshot.data!;
                                return Card(
                    ...
                    Padding(
                      ...
                      child: StreamBuilder<List<HomeRecord>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          List<HomeRecord> columnHomeRecordList =
                              snapshot.data!;
                          return Column(
                            mainAxisSize: MainAxisSize.max,
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: Builder(
                                        builder: (context) {
                                          final classesRef = columnHomeRecord
                                              .classesRef
                                              .toList();
                                          return SingleChildScrollView(
                                            scrollDirection: Axis.horizontal,
