...
class ClassListFilterWidget extends StatefulWidget {
  const ClassListFilterWidget({
    Key? key,
    String? type1,
    String? type2,
  })  : this.type1 = type1 ?? 'none',
        this.type2 = type2 ?? 'none',
        super(key: key);
  ...
  @override
  _ClassListFilterWidgetState createState() => _ClassListFilterWidgetState();
}

class _ClassListFilterWidgetState extends State<ClassListFilterWidget> {
  @override
  void initState() {
    super.initState();
          ...
          builder: (context, snapshot) {
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, listViewIndex) {
                ...
                return Visibility(
                  visible:
                      (widget.type1 == listViewClassesRecord.exerciseType) ||
                          (widget.type2 == listViewClassesRecord.exerciseType),
                  child: Padding(
                    ...
                    child: Container(
                      ...
                      child: InkWell(
                        onTap: () async {
                          logFirebaseEvent(
                              'CLASS_LIST_FILTER_Row_3pblmhqv_ON_TAP');
                              ...
                              children: [
                                Stack(
                                  ...
                                  children: [
                                    ...
                                    Align(
                                      alignment:
                                          AlignmentDirectional(0.35, 0.35),
                                      child: Text(
                                        listViewClassesRecord.creditsRequired!
                                            .toString(),
