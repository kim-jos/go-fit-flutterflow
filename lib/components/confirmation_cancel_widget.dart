...
class ConfirmationCancelWidget extends StatefulWidget {
  ...
  final DocumentReference? myReservationsRef;
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        ...
                        final myReservationsUpdateData =
                            createMyReservationsRecordData(
                          status: 'canceled',
                        );
                        await widget.myReservationsRef!
                            .update(myReservationsUpdateData);
                        // Increment credits
